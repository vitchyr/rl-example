...
function M.analyze_sarsa(sarsa_factory, fname_base)
    ...
    local analyzer = rl.SarsaAnalyzer(opt, mdp_config, qvanalyzer, sarsa_factory)

    analyzer:eval_lambdas('images/' ..fname_base .. '_rms_vs_lambda.eps')
    analyzer:eval_l0_l1_rms('images/' ..fname_base .. '_rms_vs_iteration.eps')
end
